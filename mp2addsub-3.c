...
void addStr(stype inp) {
  ...
  while(len1 >= 0 || len2 >= 0) {
    ...
    temp = ( (x.num1[len1]) + (x.num2[len2]) + rem ) % inp.bs;
    rem = ( (x.num1[len1]) + (x.num2[len2]) + rem ) / inp.bs;
    
    //printf("\n%d + %d = %d r %d", x.num1[len1], x.num2[len2], temp, rem);
...
void subStr(stype inp) {
  ...
  while(len1 >= 0 || len2 >= 0) {
    ...
    if(x.num1[len1] < x.num2[len2]){
      ctr = len1 - 1;
      while(x.num1[ctr] < 1) {
        ctr--;
      }
      temp = ( (x.num1[len1] + inp.bs) - (x.num2[len2]) ) % inp.bs;
      x.num1[ctr] -= 1;
      ctr += 1;
      while(ctr < len1) {
      ...
      temp = ( (x.num1[len1] ) - (x.num2[len2]) ) % inp.bs;
    }
    
    //printf("\n%d - %d = %d\t", x.num1[len1], x.num2[len2], temp);     
