...
//*/
	...
	//check if guesses are correct
		...
		printf("\n\n\n\tSuitable money transfers have been made. \n\tTransaction successful.");
		printf("\n\n\n\n\n**Press any key to view the bank account.");
		getch();
		system("CLS");
	
	//display of current amount
		printf("***************** B A N K  A C C O U N T S *****************");
		printf("\n\n\n\tBanker has PhP %d capital", bk);
		if(p1f)
			printf("\n\n\n\tPlayer 1 account :  PhP %d", p1);
		else
		    printf("\n\n\tPlayer 1 account CLOSED.");
		if(p2f)
			printf("\n\n\tPlayer 2 account :  PhP %d", p2);
		else
		    printf("\n\n\tPlayer 2 account CLOSED.");
		if(p3f)
			printf("\n\n\tPlayer 3 account :  PhP %d", p3);
		else
		    printf("\n\n\tPlayer 3 account CLOSED.");
		printf("\n\n\n\n\n**Press any key to continue.");
		getch();
		system("CLS");	
	...
	//check for elimination
		...
		if(p1f==0 && p2f==0 && p3f==0){
			printf("\n\nAll Bank Accounts are CLOSED.");	break;
		}
